...
*/
public class SudokuInteractive1 extends Sudoku1  {
	//private String file;
	
	public SudokuInteractive1(int[][] array, String file) {
		super(array);
		//this.file = file;
