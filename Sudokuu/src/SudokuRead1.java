...
*/
public class SudokuRead1 extends Sudoku1 {

	public SudokuRead1(int[][] array){
		super(array);
	}
 ...
 * @return Sudoku
 */	
	public static Sudoku1 readSudoku(String BadSudokuFile) throws IllegalArgumentException, IOException {
/**
 ...
 */
		...
		Sudoku1 a1 = new Sudoku1 (bigArray);
