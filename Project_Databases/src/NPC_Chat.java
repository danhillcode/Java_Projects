...
public class NPC_Chat {
	...
	public static void createTableNPC_Chat() throws FileNotFoundException, SQLException, ClassNotFoundException {
		...
		try {
			...
			// Adds the serial
			String sql = "CREATE TABLE NPC_Chat " + "(id serial UNIQUE primary key," + " chat_description TEXT not NULL, "
					+ "  NPC_ID int REFERENCES Games(id) )";
