...
public class Items_Table {
	...
	public static void createTableItems() throws FileNotFoundException, SQLException, ClassNotFoundException {
		...
		try {
			...
			// Adds the serial
			String sql = "CREATE TABLE Items " + "(id serial UNIQUE primary key," + " item_name TEXT not NULL, "
